...
public class SystemLogController {
    ...
    @GetMapping("/list")
    @Loggable(actionType = "获取 | 日志", actionDetail = "访问数据库获取信息")
    ...
    // 根据ID查找（示例）
    @GetMapping("/findById")
    @Loggable(actionType = "查询 | 日志", actionDetail = "访问数据库查询信息")
    ...
    // 新增
    @PostMapping("/save")
    @Loggable(actionType = "新增 | 日志", actionDetail = "新增信息")
    ...
    // 更新
    @PostMapping("/update")
    @Loggable(actionType = "更新 | 日志", actionDetail = "更新信息")
    ...
    // 删除
    @GetMapping("/del")
    @Loggable(actionType = "删除 | 日志", actionDetail = "删除信息")
    ...
    @Loggable(actionType = "查询 | 日志", actionDetail = "分页多条件模糊查询信息")
